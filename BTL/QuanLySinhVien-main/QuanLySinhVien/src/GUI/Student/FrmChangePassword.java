...
import GUI.FrmLogin;
import GUI.InitGUI;
import GUI.Student.FrmChangePassword;
...
public class FrmChangePassword extends JDialog{
	...
	public FrmChangePassword(FrmLogin frmLG, FrmManHinhChinh frmMHC, Connection conn, String userName) {
		...
		lblOldPassword.setBounds(25, 60, 100, 20);
		...
		lblShowPassword.setBounds(230, 240, 146, 20);
